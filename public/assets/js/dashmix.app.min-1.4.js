...
! function(e) {
                ...
                value: function() {
                    jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.pixelcave.helpers.core", function(e) {
                        ...
                        t.addClass("js-scroll-to-enabled"), jQuery("html, body").animate({
                            scrollTop: jQuery(o).offset().top - l
                        }, n)
                    })
                }
            }, {
                    ...
                    jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function(e, a) {
                        ...
                        t.addClass("js-click-ripple-enabled").css({
                            ...
                            0 === t.children(".click-ripple").length ? t.prepend('<span class="click-ripple"></span>') : t.children(".click-ripple").removeClass("animate"), (a = t.children(".click-ripple")).height() || a.width() || (o = Math.max(t.outerWidth(), t.outerHeight()), a.css({
                                height: o,
                                width: o
                            })), n = e.pageX - t.offset().left - a.width() / 2, l = e.pageY - t.offset().top - a.height() / 2, a.css({
                                top: l + "px",
                                left: n + "px"
                            }).addClass("animate")
                        })
                        ...
                        o.addClass("js-table-checkable-enabled"), jQuery("thead input:checkbox", o).on("click.pixelcave.helpers", function(a) {
                            ...
                            if (!("checkbox" === a.target.type || "button" === a.target.type || "a" === a.target.tagName.toLowerCase() || jQuery(a.target).parent("a").length || jQuery(a.target).parent("button").length || jQuery(a.target).parent(".custom-control").length || jQuery(a.target).parent("label").length)) {
                                var t = jQuery("input:checkbox", a.currentTarget),
                                    o = t.prop("checked");
                                t.prop("checked", !o).change(), e.tableToolscheckRow(t, !o)
                            }
                        })
                    })
                }
                ...
                value: function() {
                    ...
                    jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(function(a, t) {
                        var o = jQuery(t),
                            ...
                            s = {
                                line: function() {
                                    i.type = n, i.lineWidth = o.data("line-width") || 2, i.lineColor = o.data("line-color") || "#0665d0", i.fillColor = o.data("fill-color") || "#0665d0", i.spotColor = o.data("spot-color") || "#495057", i.minSpotColor = o.data("min-spot-color") || "#495057", i.maxSpotColor = o.data("max-spot-color") || "#495057", i.highlightSpotColor = o.data("highlight-spot-color") || "#495057", i.highlightLineColor = o.data("highlight-line-color") || "#495057", i.spotRadius = o.data("spot-radius") || 2, i.tooltipFormat = "{{prefix}}{{y}}{{suffix}}"
                                },
                                bar: function() {
                                    i.type = n, i.barWidth = o.data("bar-width") || 8, i.barSpacing = o.data("bar-spacing") || 6, i.barColor = o.data("bar-color") || "#0665d0", i.tooltipFormat = "{{prefix}}{{value}}{{suffix}}"
                                },
                                pie: function() {
                                    i.type = n, i.sliceColors = ["#ffb119", "#8dc451", "#3c90df", "#e04f1a"], i.highlightLighten = o.data("highlight-lighten") || 1.1, i.tooltipFormat = "{{prefix}}{{value}}{{suffix}}"
                                },
                                tristate: function() {
                                    i.type = n, i.barWidth = o.data("bar-width") || 8, i.barSpacing = o.data("bar-spacing") || 6, i.posBarColor = o.data("pos-bar-color") || "#82b54b", i.negBarColor = o.data("neg-bar-color") || "#e04f1a"
                                }
                            };
                        s[n] ? (s[n](), "line" === n && ((o.data("chart-range-min") >= 0 || o.data("chart-range-min")) && (i.chartRangeMin = o.data("chart-range-min")), (o.data("chart-range-max") >= 0 || o.data("chart-range-max")) && (i.chartRangeMax = o.data("chart-range-max"))), i.width = o.data("width") || "120px", i.height = o.data("height") || "80px", i.tooltipPrefix = o.data("tooltip-prefix") ? o.data("tooltip-prefix") + " " : "", i.tooltipSuffix = o.data("tooltip-suffix") ? " " + o.data("tooltip-suffix") : "", "100%" === i.width ? r || (r = !0, jQuery(window).on("resize.pixelcave.helpers.sparkline", function(a) {
                            clearTimeout(l), l = setTimeout(function() {
                                e.sparkline()
                            }, 500)
                        })) : jQuery(t).addClass("js-sparkline-enabled"), jQuery(t).sparkline(o.data("points") || [0], i)) : console.log("[jQuery Sparkline JS Helper] Please add a correct type (line, bar, pie or tristate) in all your elements with 'js-sparkline' class.")
                    })
                }
            }]), e
        }();
    ...
    function r(e, a) {
        return !a || "object" !== l(a) && "function" != typeof a ? function(e) {
    ...
    var d = function(e) {
        function a() {
            ...
            return function(e, a) {
                if (!(e instanceof a)) throw new TypeError("Cannot call a class as a function")
            }(this, a), e = r(this, i(a).call(this)), "demo.pixelcave.com" == '' && (jQuery("body").html(""), location.href = "https://goo.gl/mDBqx1"), e
        }
        return function(e, a) {
    ...
    a.default = d, jQuery(function() {
        window.Dashmix = new d
    })
}, function(e, a, t) {
    "use strict";
    Object.defineProperty(a, "__esModule", {
    ...
    var i = function() {
        ...
        return function(e, a, t) {
            ...
            value: function() {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', function(t) {
                    ...
                    var n = jQuery(t.currentTarget),
                        l = n.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + l + '"]').addClass("active"), o.default.updateTheme(e, l), e = jQuery("#css-theme"), a && Cookies.set("dashmixThemeName", l, {
                        expires: 7
                    }), n.blur()
                })
            }
            ...
            value: function() {
                ...
                "init" === n ? s[n]() : (e = l instanceof jQuery ? l : jQuery(l)).length && (a = jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]', e), t = jQuery('[data-toggle="block-option"][data-action="content_toggle"]', e), s[n] && s[n]())
            }
        }, {
            key: "init",
            value: function() {
